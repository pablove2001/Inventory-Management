...
public class FrameSearchRecord extends JFrame implements ActionListener {
	...
	public FrameSearchRecord(int id) {
		// Create JPanel
		jpPanel = new JPanel();
		// Create JFrame
		jfFrame = new JFrame();
		// Create JTable
		String[][] information = Record.toFrameSearch(id);
		String[] header = { "Product Name", "Quantity"};
		...
		jfFrame.setTitle("InputOutput ID: "+ id);
